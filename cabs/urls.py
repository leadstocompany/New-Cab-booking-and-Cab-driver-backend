...
urlpatterns = [
    ...
    # re_path(r'^(?P<cab_type_id>\d+)/(?P<cab_maker_id>\d+)/vehicle-model/$', views.VehicleModelAPI.as_view(),),
    re_path(r'^(?P<cab_type_id>\d+)/(?P<cab_maker_id>\d+)/vehicle-model/$', views.VehicleModelAPI.as_view(), name='vehicle-model'),
